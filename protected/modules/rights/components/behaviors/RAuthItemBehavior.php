...
class RAuthItemBehavior extends CBehavior
{
	...
	*/
	public function getRevokePermissionLink(CAuthItem $role)
	{
        ...
        return CHtml::link(CHtml::image('/images/ok.png', Rights::t('core', 'Revoke'), array('width' => '20', 'height' => '20')), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
	...
	*/
	public function getAssignPermissionLink(CAuthItem $role)
	{
        ...
        return CHtml::link(CHtml::image('/images/stop.png', Rights::t('core', 'Assign'), array('width' => '20', 'height' => '20')), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
