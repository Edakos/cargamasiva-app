 ...
 * @property integer $cabecera_cantonal
 * @property integer $capital_provincial
 * @property integer $cambio
 * @property integer $ojo
 *
...
class Parroquia extends MyActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('cabecera_cantonal',$this->cabecera_cantonal);
		$criteria->compare('capital_provincial',$this->capital_provincial);
		$criteria->compare('cambio',$this->cambio);
		$criteria->compare('ojo',$this->ojo);
