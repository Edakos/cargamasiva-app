...
class Seccion extends MyActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('formulario_id, created_by, modified_by', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, formulario_id, created, modified, created_by, modified_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'preguntas' => array(self::HAS_MANY, 'Pregunta', 'seccion_id'),
