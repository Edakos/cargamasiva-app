...
roles
DESCRIPTION
Este comando genera una jerarquia de autorización inicial usando Control de Acceso basado en Roles (RBAC)
EOD;
	}
	...
	*/
	...
	//ensure that an authManager is defined as this is mandatory for creating an auth heirarchy
        ...
        echo "Este commando creará tres roles: representante, supervisor y administrador, y los siguientes permisos:\n";
        ...
        if (!strncasecmp(trim(fgets(STDIN)), 's', 1)) {
            ...
            $role=$this->_authManager->createRole("representante");
            ...
            echo "La jerarquía de autorizaciones fue creada con éxito.";
        }
	}
}
